<template>
  <v-container fluid>
    ...
    <head>
      ...
      <link
        rel="stylesheet"
        href="https://storage.googleapis.com/stockpileapp/style4.css"
      />
    </head>
    <body>
      <main role="main">
        <section class="ui-section-hero py-8">
          <div class="ui-layout-container">
            <!-- COPYWRITING -->
            <div class="ui-layout-column-6 ui-layout-column-center">
              <img
                src="https://storage.googleapis.com/stockpileapp/SquareNoBG_animated.svg"
                style="width: 10rem"
              />
              <h1 style="font-size: 32px">Welcome to Stockpile</h1>
              <p class="ui-text-intro">
                Stockpile is a simple inventory tracking solution that enables
                families to easily track household items, and who purchased
                them.
              </p>
              <!-- CTA -->
        ...
        <section class="ui-section-content">
          <div class="ui-layout-container">
            <div
              class="ui-section-content__layout ui-layout-grid ui-layout-grid-2"
            >
              <div class="ui-component-card ui-layout-column-4">
                <img
                  src="../assets/pexels-photo-9999999.jpg"
                  alt="#"
                  loading="lazy"
                  class="ui-component-card--image"
                />
                <h4 class="ui-component-card--title">
                  Start organising faster.
                </h4>
                <p>Organize your inventory at the touch of a button.</p>
              </div>
              <div class="ui-component-card ui-layout-column-4">
                <img
                  src="../assets/pexels-photo-4259140.jpeg"
                  alt="#"
                  loading="lazy"
                  class="ui-component-card--image"
                />
              ...
              <div class="ui-component-card ui-layout-column-4">
                <img
                  src="../assets/pexels-photo-4559555.jpeg"
                  alt="#"
                  loading="lazy"
                  class="ui-component-card--image"
                />
        ...
        <section class="ui-section-close pt-8">
          <div class="ui-layout-container">
            <div class="ui-layout-column-6 ui-layout-column-center">
              ...
              <div class="ui-component-cta ui-layout-flex">
                <p>
                  <small
                    >Stockpile is available on any device with an internet
                    connection.</small
                  >
                </p>
                <v-btn
