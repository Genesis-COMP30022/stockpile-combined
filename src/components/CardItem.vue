<template>
  <div>
    <v-card class="mx-auto" max-width="400">
      <v-card-title
        style="word-break: break-word; display: flex; flex-wrap: nowrap"
      >
        <v-icon class="mr-3 d-inline" style="display: inline">
          {{ mdiIcons[cat] }}
        </v-icon>
      ...
      <v-img class="white--text align-end mb-2" height="200px" :src="img">
      </v-img>
      ...
      >
        <v-dialog v-model="dialog" width="800" v-if="showEdit == true">
        ...
        <v-chip color="sLightBlue" elevation="0" class="mx-0">
