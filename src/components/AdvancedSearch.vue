...
export default {
  ...
  createPDF () {
            ...
            let sDateMod = this.sDate.map(x => new Date(x).toLocaleDateString('en-AU'));

            if (sDateMod[0] != null){
                doc.text(35,txtLocation, "Date range: " + sDateMod[0] + " ~ " + sDateMod[1]);
                txtLocation += 5;
            }
