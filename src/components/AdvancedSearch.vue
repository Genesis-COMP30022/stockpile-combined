...
export default {
  ...
  methods: {
    ...
    submitAdvancedSearch() {
      ...
      let originalTerm = this.sTerm
      let originalBuyer = this.sBuyer
      let originalCat = this.sCat
      ...
      this.sTerm = originalTerm
      this.sBuyer = originalBuyer
      this.sCat = originalCat
